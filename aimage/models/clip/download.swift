...
func download_clip(){
    ...
    do {
      ...
      UserDefaults.standard.set(savedURL, forKey: "Clip")
    }
    catch {
  ...
  UserDefaults.standard.set("40d365715913c9da98579312b702a82c18be219cc2a73407c4526f58eba950af", forKey: "Clip_Checksum") // TODO: Check this SHA256 checksum to make sure corruption or tampering didn't happen.
