...
func download_clip(){
    ...
    do {
      ...
      UserDefaults.standard.setValue(savedURL, forKey: "Clip")
      UserDefaults.standard.setValue("40d365715913c9da98579312b702a82c18be219cc2a73407c4526f58eba950af", forKey: "Clip_Checksum") // TODO: Check this SHA256 checksum to make sure corruption or tampering didn't happen.
      print(savedURL)
      print(UserDefaults.standard.url(forKey: "Clip"))
    }
    catch {
